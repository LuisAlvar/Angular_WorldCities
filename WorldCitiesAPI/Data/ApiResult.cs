...
{
  /// <summary>
  /// Servers as wapper object for the actual data contain in the List<t> Data :: Cities/Countries
  /// </summary>
  /// <typeparam name="T">For any EF Core Entity</typeparam>
  public class ApiResult<T>
  {
    ...
    /// <summary>
    /// Number of times contained in each page
    /// </summary>
