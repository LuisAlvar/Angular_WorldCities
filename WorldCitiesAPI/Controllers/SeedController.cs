...
namespace WorldCitiesAPI.Controllers
{
  ...
  public class SeedController: ControllerBase
  {
    ...
    public async Task<ActionResult> CreateDefaultUsers()
    {
      ...
      {
        // create a new dmin Application User account 
        ...
        // assign the "RegisteredUser" amd "Administrator" roles to user
      ...
      if (await _userManager.FindByNameAsync(email_User) == null)
      {
        ...
        // confirm the email and remove layout
      ...
      // if we added at least one suer, persist  the changes into the DB
