...
namespace WorldCitiesAPI.Tests
{
  public class SeedController_Tests
  {
    ...
    public async Task CreateDefaultUsers()
    {
      ...
      // create a applicaitondbcontext instance using the in-memory db 
      using var context = new ApplicationDbContext(options);

      // create a rolemanger instance 
       ...
       * Act
       * 
       * Execute  the SeedController's CreateDefaultUser() 
      ...
      // retrieve the users
      user_Admin = await userManager.FindByNameAsync("admin@email.com");
